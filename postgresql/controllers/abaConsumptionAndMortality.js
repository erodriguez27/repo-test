const DBlayer = require("../models/abaConsumptionAndMortality");
...
exports.findAllWithTimes = async function(req, res) {

    try {
        let records = await DBlayer.DBfindAllWithTimes();
        res.status(200).json({
            statusCode: 200,
            data: records
        });
...
exports.addConsAndMort = async function(req, res) {

    try {
        let records = await DBlayer.DBaddConsAndMort(req.body);
        res.status(200).json({
            statusCode: 200,
            data: records
        });
...
exports.updateConsAndMort = async function(req, res) {

    try {
        let records = await DBlayer.DBupdateConsAndMort(req.body);
        res.status(200).json({
            statusCode: 200,
            data: records
        });
