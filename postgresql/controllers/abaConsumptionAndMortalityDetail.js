const DBlayer = require("../models/abaConsumptionAndMortalityDetail");
...
exports.findById = async function(req, res) {
    ...
    try {
        let records = await DBlayer.DBfindById(req.body);
        res.status(200).json({
            statusCode: 200,
            data: records
        });
...
exports.findByConsumptionAndMortalityId = async function(req, res) {

    try {
        let records = await DBlayer.DBfindByConsumptionAndMortalityId(req.body);
        res.status(200).json({
            statusCode: 200,
            data: records
        });
