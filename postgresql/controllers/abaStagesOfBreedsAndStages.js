const DBlayer = require("../models/abaStagesOfBreedsAndStages");
...
exports.findByIdBreedsAndStages = async function(req, res) {

    try {
        let records = await DBlayer.DBfindByIdBreedsAndStages(req.body.id);
        res.status(200).json({
            statusCode: 200,
            data: records
        });
