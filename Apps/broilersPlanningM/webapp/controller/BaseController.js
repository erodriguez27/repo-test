sap.ui.define([
    ...
    "broilersPlanningM/model/formatter"
], function (Controller,formatter) {
    "use strict";
    var farmDetailsDlg, groupDetailsDlg, farmsDialog, centersDialog, shedsDialog;

    return Controller.extend("broilersPlanningM.controller.BaseController", {
        formatter: formatter,

        setFragments : function () {

            farmDetailsDlg = sap.ui.xmlfragment("broilersPlanningM.view.Popover", this);
            this.getView().addDependent(farmDetailsDlg);

            groupDetailsDlg = sap.ui.xmlfragment("broilersPlanningM.view.programmed.productDialog", this);
            this.getView().addDependent(groupDetailsDlg);

            farmsDialog = sap.ui.xmlfragment("broilersPlanningM.view.reports.farmDialog", this);
            this.getView().addDependent(farmsDialog);

            centersDialog = sap.ui.xmlfragment("broilersPlanningM.view.reports.centerDialog", this);
            this.getView().addDependent(centersDialog);

            shedsDialog = sap.ui.xmlfragment("broilersPlanningM.view.reports.shedDialog", this);
