sap.ui.define([
    ...
    return Controller.extend("incubatorPlanningM.controller.BaseController", {
        formatter: formatter,

        setFragments : function () {

            //farmDetailsDlg = sap.ui.xmlfragment("incubatorPlanningM.view.Popover", this);
            //this.getView().addDependent(mermaDetailsDlg);

            groupDetailsDlgLot = sap.ui.xmlfragment("incubatorPlanningM.view.inventory.inventoryDialogLot", this);
            this.getView().addDependent(groupDetailsDlgLot);

            groupDetailsDlg = sap.ui.xmlfragment("incubatorPlanningM.view.inventory.inventoryDialog", this);
