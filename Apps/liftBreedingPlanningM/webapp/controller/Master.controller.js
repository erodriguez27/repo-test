sap.ui.define([
    ...
    "sap/m/Button",
    "sap/m/Text",
    "liftBreedingPlanningM/controller/MasterUserAppController",
], function (BaseController, Filter, FilterOperator, MessageToast, Dialog, Button, Text) {
    "use strict";

    const farm_type = 3; 
    return BaseController.extend("liftBreedingPlanningM.controller.Master", {
